...
La versión reestructurada vive en `_build/redaccion/informe-02c/`. Las dos anteriores se conservan sin tocar: `informe-02/` (versión temática, 43 páginas) e `informe-02b/` (edición de decisiones, 52 páginas).
...
|---|---|---|---|---|
| Resumen ejecutivo | `informe-02b/00-resumen.md`, reescrito sin cifras promediadas | — | — | — |
| I. Introducción | `informe-02b/01-objeto.md` y `02-metodologia.md`, comprimidos | — | — | — |
...
| III. La evaluación universitaria | `informe-02b/04-evaluacion.md` casi íntegro | Scarfe et al. (2024); Liang et al. (2023); Sydney; TEQSA | G2 | Instrumentos: la clasificación es valoración del autor, no medición |
| IV. Inteligencia artificial y aprendizaje | `informe-02b/05-practica.md` y `06-retroalimentacion.md` §3 | Bastani et al. (2025); Kestin et al. (2025); Wang y Fan retractado | G3 | — |
...
| VIII. Respuestas institucionales comparadas | `informe-02b/B-material-institucional.md` | Fuentes institucionales primarias del cap. 17 | Tabla 6 | Contraste con fuentes primarias pendiente |
| IX. Universidad y formación profesional | `informe-02b/08-acreditacion.md` | Brynjolfsson et al. (2026); NACE 2026 | — | Traslado a Chile no acreditado |
| X. La enseñanza del Derecho | `informe-02b/09-derecho.md` casi íntegro | Magesh et al. (2025); Charlotin (2026); Choi y Schwarcz (2025) | — | — |
| XI. Implicancias para la Escuela | `informe-02b/11-decisiones.md`, reformulado sin imperativos | Faúndez-Ugalde et al. (2024) | — | — |
| XII. Conclusiones | Nuevo | — | — | — |
| Anexo A. Metodología | `informe-02b/A-metodologia-tecnica.md`, sin las medias | — | — | — |
| Anexo B. Matriz de evidencia | Anexo B del informe experto, con las siete columnas pedidas | Todo el corpus | — | — |
| Anexo C. Casos institucionales | `informe-02b/B-material-institucional.md` §B.1 | — | — | — |
| Anexo D. Evidencia sobre enseñanza jurídica | Cap. 13 del informe experto | — | — | — |
| Anexo E. Declaración de uso de IA | `informe-02b/C-uso-de-ia.md`, reducido a media página | — | — | — |
| Anexo F. Referencias | `informe-02b/12-referencias.md` | — | — | — |
...
Las diez figuras de la edición 02b que no sobreviven se conservan en `figuras/informe-02b/`.
