...
const H = JSON.parse(fs.readFileSync(path.join(RAIZ, 'hechos', 'ronda-3-hallazgos.json'), 'utf8'));
...
for (const cambio of H.cambios_propuestos) {
  ...
  celda.ronda3 = { motivo: cambio.motivo, fuentes: cambio.fuentes };
  celda.sin_contrastar = false;
...
R.ronda3 = {
  ...
  fuentes_nuevas: H.fuentes.length,
  nota: 'Cambios acreditados en la tercera ronda de búsqueda. Cada celda modificada conserva su estado anterior en los campos estado_anterior y puntos_anterior.',
};
