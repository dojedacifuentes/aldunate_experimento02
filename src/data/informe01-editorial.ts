...
export const informe01Lagunas: Informe01Laguna[] = [
  ...
  {
    id: 'L-5',
    titulo: 'La verificación sustantiva está a medias, y su reparto tiene su propio sesgo',
    cuerpo:
      '{verificadas} de las {fuentes} fuentes fueron abiertas y contrastadas contra su publicación original; once no decían lo que el registro les atribuía. Las {noVerificadas} restantes conservan el contenido que les asignó la investigación previa, y que una URL responda no prueba que diga lo que se le atribuye. El reparto además no es uniforme: la PUCV llega al 86 % de sus fuentes contrastadas y la Universidad Autónoma al 0 %, de modo que la institución sobre la que este informe debe ser más cuidadoso es también aquella cuyos registros están más comprobados.',
    cierre:
      'Contrastar las {noVerificadas} restantes, empezando por las instituciones con menor proporción verificada, y no por las que ya la tienen alta. Y resolver expresamente si «verificado» significa responsabilidad editorial o ejecución material del contraste, que hoy es una ambigüedad declarada y no resuelta.',
    ronda: 1,
    alcance: 'metodo',
  },
  {
