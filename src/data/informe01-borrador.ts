...
export const informe01MetodologiaRelato: readonly {
  ...
  },
  {
    ...
    parrafos: [
      ...
      'La enmienda añade dos ejes y no recodifica ningún registro. El primero es el **mecanismo**: qué clase de instrumento institucional es cada iniciativa —unidad, norma, programa formativo, asignatura, herramienta, proyecto, actividad, convenio o publicación—. Es una clasificación de lo que el registro ya contenía en su nombre, su unidad responsable y sus productos, de modo que no aporta evidencia nueva y no reabre la verificación de ninguna fuente. El segundo son las **{capacidades} capacidades**, cada una derivada por una regla mecánica sobre campos ya verificados, y cada una con la pregunta que responde escrita al lado.',
